...
const Estudio: FunctionComponent<CambioElementoProps> = ({
  ...
  return (
    <div className="relative flex w-full h-full flex-col items-start justify-start gap-3 overflow-y-scroll font-nerdS">
      <div className="relative w-full h-fit flex flex-wrap items-center justify-between gap-12">
        <div className="relative w-full max-w-[50vw] h-full lg:h-[30rem] bg-gradient-to-r from-naranja border border-naranja to-[#D84599] p-2 flex overflow-hidden rounded-md items-center justify-center">
          <Juego
        ...
        <div className="relative w-fit h-full flex overflow-y-scroll text-white">
          <div className="relative w-96 flex items-start justify-start">
      ...
      <div className="relative w-full h-fit p-4 items-center justify-center flex flex-col gap-10">
        <div className="relative w-full h-fit flex items-center justify-center gap-5 flex-col sm:flex-row bottom-0">
          <div className="relative w-fit h-fit flex items-center justify-center text-[#9CF38C] uppercase text-center">
            {dict.Home.player}
          </div>
        ...
        <div className="relative w-full h-fit flex items-start sm:items-center justify-center sm:justify-start gap-5 flex-col sm:flex-row bottom-0">
          <div className="relative w-fit h-fit flex items-center justify-center text-rosa uppercase text-center">
            {dict.Home.scene}
          </div>
          <div className="relative w-full max-w-[36rem] h-fit flex items-start justify-start overflow-x-auto">
            <div className="relative scroll-container h-fit flex items-start justify-start gap-4">
